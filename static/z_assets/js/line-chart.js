// if ($('#coin_sales10').length) {
//     var ctx = document.getElementById("coin_sales10").getContext('2d');
...
//                 borderColor: '#0b76b6',
//                 data: [18, 50,90,150,2,41, 86, 49, 20, 35, 20, 50, 49, 30, 45, 25],
//             }]
//         },
...
if ($('#amlinechart4').length) {
    var chart = AmCharts.makeChart("amlinechart4", {
        ...
        "graphs": [{
            ...
            "balloonText": "place taken by india in [[category]]: [[value]]",
            "hidden": false ,
            "bullet": "round",
            "title": "india",
            "valueField": "india",
...
/*-------------- 1 line chart amchart start ------------*/
if ($('#amlinechart10').length) {
    var chart = AmCharts.makeChart("amlinechart10", {
        "type": "serial",
        "theme": "light",
        "marginRight": 20,
        "autoMarginOffset": 20,
